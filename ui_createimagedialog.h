...
public:
    ...
    {
        CreateImageDialog->setWindowTitle(QApplication::translate("CreateImageDialog", "Create a disk image", 0, QApplication::UnicodeUTF8));
        stdSingleButton->setText(QApplication::translate("CreateImageDialog", "Standard single density", 0, QApplication::UnicodeUTF8));
        stdEnhancedButton->setText(QApplication::translate("CreateImageDialog", "Standard enhanced (also called medium or dual) density", 0, QApplication::UnicodeUTF8));
        stdDoubleButton->setText(QApplication::translate("CreateImageDialog", "Standard double density", 0, QApplication::UnicodeUTF8));
        doubleDoubleButton->setText(QApplication::translate("CreateImageDialog", "Double sided double density", 0, QApplication::UnicodeUTF8));
        harddiskButton->setText(QApplication::translate("CreateImageDialog", "Double density harddisk", 0, QApplication::UnicodeUTF8));
        customButton->setText(QApplication::translate("CreateImageDialog", "Custom", 0, QApplication::UnicodeUTF8));
        label_4->setText(QApplication::translate("CreateImageDialog", "Number of sectors:", 0, QApplication::UnicodeUTF8));
        label_5->setText(QApplication::translate("CreateImageDialog", "Sector density:", 0, QApplication::UnicodeUTF8));
        densityCombo->clear();
        densityCombo->insertItems(0, QStringList()
         << QApplication::translate("CreateImageDialog", "Single (128 bytes per sector)", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("CreateImageDialog", "Double (256 bytes per sector)", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("CreateImageDialog", "512 bytes per sector", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("CreateImageDialog", "8192 bytes per sector", 0, QApplication::UnicodeUTF8)
        );
        capacityLabel->setText(QApplication::translate("CreateImageDialog", "Total image capacity: 92160 bytes (90 K)", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
