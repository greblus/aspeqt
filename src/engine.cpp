    ...
    : QObject(parent)
{
    ...
    // The Atari's boot handler poll is broadcast to $4F, not to $50; answering
    // it lets the 850 handler load itself over SIO (see RDevicePoll).
    sio->installDevice(0x4F, new RDevicePoll(sio, m_rDevice));
